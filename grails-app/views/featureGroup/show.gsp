...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:message code="featureGroup.features.label" default="Features"/></td>

                <td valign="top" style="text-align: left;" class="value">
                    <ul>
                        <g:each in="${featureGroupInstance.features}" var="f">
                            <li><g:link controller="feature" action="show"
